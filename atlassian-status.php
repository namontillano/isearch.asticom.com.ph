                ...
                <div class="container">
                    <div class="section-head text-center mb-80 style-5">
                        <div class="page-links color-999">
                            ...
                            <a href="<?=URL_ROOT;?>atlassian-status.php" class="color-000">
                                <?php echo $pagetitle; ?>
                            </a>
                        </div>
                    </div>
                    <div class="section-head text-center style-4 mb-20">
                        <h2 class="mb-10"> Atlassian <span> Status </span></h2>
                    </div>

                    <div class="row">
                        <div class="col-md-12 mb-10">

                            <iframe id="innerFrame" name="innerFrame" sandbox="allow-scripts allow-popups allow-forms allow-same-origin allow-popups-to-escape-sandbox allow-downloads" frameborder="0" allowfullscreen="" src="https://status.atlassian.com/" width="100%" height="2400px" style="overflow: auto;">
                            </iframe>
