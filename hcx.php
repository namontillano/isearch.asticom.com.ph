...
if (preg_match('/\b@hcx\b/', $_SESSION['google_email_address'])) { $subsidiaries = true; } else { $subsidiaries = false; }
                ...
                <div class="container">
                    ...
                    <div class="section-head text-center mb-80 style-5">
                        <div class="page-links color-999">
                            ...
                            <span class="me-2">/</span>
                            <a href="<?=URL_ROOT;?>hcx.php" class="color-000">
                                <?php echo $pagetitle; ?>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 mb-50 text-center">
                            <img src="<?=ASSETS;?>custom/img/subsidiaries/hcx.png" class="rounded img-fluid" style="max-height: 200px">
                        </div>
                    </div>
