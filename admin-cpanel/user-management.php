                                                        ...
                                                        while ($data = $getUserAccount->fetch(PDO::FETCH_ASSOC)) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="">
                                                                    ...
                                                                    if (in_array(1, $arr)) { 
                                                                        echo '<span class="badge bg-gray m-1" title="HR">HR</span>';
                                                                    }
                                                                    if (in_array(2, $arr)) { 
                                                                        echo '<span class="badge bg-gray m-1" title="Recruitment">REC</span>';
                                                                    }
                                                                    if (in_array(3, $arr)) { 
                                                                        echo '<span class="badge bg-gray m-1" title="Finance">FIN</span>';
                                                                    }
                                                                    if (in_array(4, $arr)) { 
...
<script>
    $(document).ready(function() {
			...
			//console.log(ex.includes(`${val.id}`));
            return $(`<option ${ex.includes(`${val.id}`) ? 'selected' : ''}></option>`).val(val.id).html(val.categories_name);
        });
