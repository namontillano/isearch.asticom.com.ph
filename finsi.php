...
if (preg_match('/\b@finsi\b/', $_SESSION['google_email_address'])) { $subsidiaries = true; } else { $subsidiaries = false; }
if (array_intersect(array(5), preg_split ("/\,/", trim($_SESSION['user_level'])))){
    $accessible = true;
} else {
    if ($subsidiaries == true) { $accessible = true; } else { $accessible = false; }
}
...
<head>
    ...
    <!-- Title  -->
    <title><?=APP_NAME." | Subsidiaries > ".$pagetitle;?></title>
                ...
                <div class="container">
                    ...
                    <div class="section-head text-center mb-80 style-5">
                        <div class="page-links color-999">
                            ...
                            <a href="<?=URL_ROOT;?>subsidiaries.php" class="me-2">
                                Subsidiaries
                            </a>
                            <span class="me-2">/</span>
                            <a href="<?=URL_ROOT;?>finsi.php" class="color-000">
                                <?php echo $pagetitle; ?>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 mb-50 text-center">
                            <img src="<?=ASSETS;?>custom/img/subsidiaries/finsi.png" class="rounded img-fluid" style="max-height: 200px">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                    <div class='text-center'>
                                        <h3 class='mb-0'>Under Maintenance</h3>
                                        <p class='text-muted mb-0'>
                                            We're working on our new i-Search website.<br>We will be back soon and better than ever!</p>
                                    </div>
                                </div>
                    </div>
